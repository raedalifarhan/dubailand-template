...
const VisitorParkingRequestForm = () => {
    return (
        <form className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-md space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label className="block text-gray-700 font-medium mb-1">التاريخ وقت من-الى:</label>
                    <input
                        type="text"
                        className="mt-1 block w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 text-base"
                    />
                ...
                <div>
                    <label className="block text-gray-700 font-medium mb-1">عدد المواقف المطلوبة:</label>
                    <input
                        type="number"
                        className="mt-1 block w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 text-base"
                    />
...
export default VisitorParkingRequestForm;
